    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-24 left-8 lg:left-16 z-10 max-w-lg">
        ...
        <div className="flex items-center gap-4 mt-6 hero-reveal">
          <a href="/work" className="px-5 py-2.5 rounded-full bg-white/5 border border-[var(--color-border)] text-sm font-medium text-white hover:bg-white/10 hover:border-[var(--color-border-glow)] transition-all duration-300">
            View Work
          </a>
          <a href="/contact" className="px-5 py-2.5 rounded-full text-sm font-medium text-[var(--color-text-muted)] hover:text-white transition-colors duration-200">
            Get in Touch
          </a>
        </div>
      </div>
      <div className="absolute bottom-24 right-8 lg:right-16 z-10 hero-reveal">
        <p className="font-mono text-[10px] uppercase tracking-widest text-[var(--color-text-faint)] text-right">Drag the badge</p>
      </div>
  ...
  return (
    <section id="about" className="py-24 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <h2 className="font-serif text-3xl lg:text-4xl text-white mb-8 scroll-reveal">
          Background
        </h2>
        ...
        <div className="grid grid-cols-3 gap-8 pt-6 border-t border-[var(--color-border)] max-w-lg mx-auto mb-10 scroll-reveal">
        ...
        <div className="max-w-lg mx-auto text-left scroll-reveal">
